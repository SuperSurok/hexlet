...
// Это значит, что функция потеряла связь с объектом и её constructor больше не указывает на объект.
setTimeout(printer.print, 1000); // Hello, undefined
// Иллюстрация
const print = printer.print;
print(); // hello, undefined
// Если контекста нет, то constructor оказывается равным пустому объекту если речь об обычных функциях.
