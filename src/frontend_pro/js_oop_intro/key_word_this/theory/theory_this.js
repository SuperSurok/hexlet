...
////////// Используем слово constructor //////////
/// constructor даёт возможность читать и менять данные
// Читать
...
////////// <------ Контекст ------> //////////
/// В JS constructor может измениится прямо во время работы программы
...
/// Вызов функции из другого объекта привел к смене объекта, на который ссылается constructor.
/// Эта особенность называется поздним связыванием.
/// Значение constructor вычисляется не во время определения кода,
...
// объект на который и будет ссылаться constructor внутри функции
