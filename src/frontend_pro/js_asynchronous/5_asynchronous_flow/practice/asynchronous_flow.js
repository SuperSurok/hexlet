...
export const compareFileSizeSecond = (file1, file2, cb) => {
    fs.stat(file1, (_err, statFile1) => {
        fs.stat(file2, (_err, statFile2) => (
            cb(null, Math.sign(statFile1.size - statFile2.size))
        ));
    });
};
